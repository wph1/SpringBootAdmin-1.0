...
public class RedisSessionDAO extends AbstractSessionDAO {
    ...
    protected Serializable doCreate(Session session) {
        ...
        redisTemplate.opsForValue().set(getKey(sessionId.toString()), session,redisConfiguration.getSessionTime(),TimeUnit.SECONDS);
        return sessionId;
    }
    ...
    public void update(Session session) {
        ...
        redisTemplate.opsForValue().set(key, session,redisConfiguration.getSessionTime(), TimeUnit.SECONDS);
    }
